...
public interface GalaxyFDS {
   ...
   * @throws GalaxyFDSClientException
   */
  void createBucketUnderOrg(String org, String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  boolean doesBucketExist(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  AccessControlList getBucketAcl(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void setBucketAcl(String bucketName, AccessControlList acl) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void deleteBucketAcl(String bucketName, AccessControlList acl) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  @Deprecated QuotaPolicy getBucketQuota(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  @Deprecated void setBucketQuota(String bucketName, QuotaPolicy quotaPolicy)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  FDSObjectListing listObjects(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  VersionListing listVersions(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  FDSObjectListing listObjects(String bucketName, String prefix) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  VersionListing listVersions(String bucketName, String prefix) throws GalaxyFDSClientException;
   ...
   */
  FDSObjectListing listObjects(String bucketName, String prefix, String delimiter, boolean reverse)
    throws GalaxyFDSClientException;
   ...
   */
  FDSObjectListing listObjects(String bucketName, String prefix, String delimiter, boolean reverse,
    boolean isBackup) throws GalaxyFDSClientException;

  /**
   * Return a list of summary information about the versions in the specified bucket
   *
   * @param listObjectsRequest The request object containing all options for listing the
   *                           objects in a specified bucket.
   * @return listing result
   * @throws GalaxyFDSClientException exception
   */
  FDSObjectListing listObjects(FDSListObjectsRequest listObjectsRequest)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  VersionListing listVersions(String bucketName, String prefix, String delimiter)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  PutObjectResult postObject(String bucketName, File file) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  PutObjectResult postObject(String bucketName, InputStream input, FDSObjectMetadata metadata)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  FDSObject getObject(String bucketName, String objectName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  FDSObject getObject(String bucketName, String objectName, String versionId)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  FDSObjectMetadata getObjectMetadata(String bucketName, String objectName)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  FDSObjectMetadata getObjectMetadata(String bucketName, String objectName, String versionId)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  AccessControlList getObjectAcl(String bucketName, String objectName, String versionId)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void setObjectAcl(String bucketName, String objectName, AccessControlList acl)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void setObjectAcl(String bucketName, String objectName, String versionId, AccessControlList acl)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void deleteObjectAcl(String bucketName, String objectName, AccessControlList acl)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  boolean doesObjectExist(String bucketName, String objectName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  boolean doesObjectExist(String bucketName, String objectName, String versionId)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void deleteObject(String bucketName, String objectName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void restoreObject(String bucketName, String objectName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  long prefetchObject(String bucketName, String objectName) throws GalaxyFDSClientException;
   ...
   */
  long prefetchUri(String bucketName, String objectName, String cdnUri)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  long refreshObject(String bucketName, String objectName) throws GalaxyFDSClientException;
   ...
   * @return rest refresh quota
   */
  long refreshUri(String bucketName, String objectName, String cdnUri)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void setPublic(String bucketName, String objectName) throws GalaxyFDSClientException;
  ...
  InitMultipartUploadResult initMultipartUpload(InitiateMultipartUploadRequest request)
    throws GalaxyFDSClientException;
  ...
  UploadPartResult uploadPart(String bucketName, String objectName, String uploadId, int partNumber,
    InputStream in) throws GalaxyFDSClientException;
  ...
  PutObjectResult completeMultipartUpload(String bucketName, String objectName, String uploadId,
    FDSObjectMetadata metadata, UploadPartResultList uploadPartResultList)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  AccessLogConfig getAccessLogConfig(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void updateAccessLogConfig(String bucketName, AccessLogConfig accessLogConfig)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  LifecycleConfig getLifecycleConfig(String bucketName) throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void updateLifecycleConfig(String bucketName, LifecycleConfig lifecycleConfig)
    throws GalaxyFDSClientException;
  ...
  void setMirror(String bucketName, String mirrorAddress) throws GalaxyFDSClientException;
  ...
  void deleteTimestampAntiStealingLinkConfig(String bucketName) throws GalaxyFDSClientException;
  ...
  CopyObjectResult copyObject(String bucketName, String srcObjectName, String dstObjectName)
    throws GalaxyFDSClientException;
   ...
   * @throws GalaxyFDSClientException
   */
  void setObjectMetadata(String bucketName, String objectName, FDSObjectMetadata metadata)
    throws GalaxyFDSClientException;

  void updateWebsiteConfig(String bucketName, WebsiteConfig websiteConfig)
    throws GalaxyFDSClientException;
