...
/**
 * Contains the results of listing the versions in an bucket,
 * including a list of {@link VersionSummary} objects describing each version,
...
public class VersionListing {
    ...
    private List<VersionSummary> versionSummaries =
        new ArrayList<VersionSummary>();
    ...
    /** The name of the bucket containing the listed versions */
     ...
     * additional requests to see the full object listing for an
     * bucket
     */
     ...
     * the associated bucket. Callers should remember that listings for large
     * buckets can be truncated for performance reasons, so callers might need
     * to make additional calls to
     * istNextBatchOfVersions() to get additional
     ...
     */
    public List<VersionSummary> getVersionSummaries() {
      return this.versionSummaries;
    }

    /**
     * For internal use only. Sets the list of version
     * summaries describing the versions stored in the associated bucket.
     *
     * @param versionSummaries
     *            The version summaries describing the versions stored in the
     *            associated bucket.
     */
    public void setVersionSummaries(List<VersionSummary> versionSummaries) {
    ...
    /**
     * Gets the name of the bucket containing the versions listed
     * in this {@link VersionListing}.
     *
     * @return The name of the bucket containing the versions listed
     *         in this VersionListing.
     */
    ...
    /**
     * For internal use only. Sets the name of the
     * bucket containing the versions listed in this VersionListing.
     *
     * @param bucketName
     *            The name of the bucket containing the versions
     *            listed in this VersionListing.
     */
     ...
     * callers to condense keys into common prefix listings. For example, if
     ...
     * whether the caller needs to make additional calls to get more
     * version summaries.
     *
     * @param truncated
     *            True if this version listing is <b>not complete</b> and the
     *            caller needs to make additional calls to get additional
     *            version summaries.
     */
